...
class DataArguments:
    ...
    train_file: str = field(default=None, metadata={"help": "Path to the training data file (JSONL)."})
    validation_file: str = field(default=None, metadata={"help": "Path to the validation data file (JSONL)."})
